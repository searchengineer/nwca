            ...
            <div class="panel-body">
                <article class="hentry" itemscope itemtype="http://schema.org/Article">
                    <header>
                        ...
                        <span class="section-date">Published: <time class="published updated" itemprop="datePublished" datetime="<?= $model->published; ?>"><?= Yii::$app->formatter->asDatetime($model->published, "php:d-m-Y"); ?></time></span>            
